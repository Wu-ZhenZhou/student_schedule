...
onStart(ServiceInstance service) async {
  ...
  // Timer.periodic(const Duration(seconds: 1), (timer) async {
    ...
    // final time = ["9:42~10:55", "10:07~10:00", "10:27~11:00", "11:10~12:00", "13:10~14:00", "14:10~15:00", "15:10~16:00", "16:10~17:00", "17:10~18:00", "18:10~18:55", "19:00~19:45", "19:50~20:35", "20:40~21:25", "21:30~22:15", "7:10~8:00", "12:10~13:00"];

    await Firebase.initializeApp();
    await DataBaseManager().downloadData('schedule');

    for(int i = 0; i<time.length; ++i){
      if(Data.schedules[(now.weekday-1)*16+i] != "" && now.hour*60+now.minute+30 == int.parse(time[i].split('~')[0].split(":")[0])*60+int.parse(time[i].split('~')[0].split(":")[1])){
